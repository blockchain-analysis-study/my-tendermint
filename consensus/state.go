...
import (
	...
	cstypes "my-tendermint/tendermint/consensus/types"
	tmevents "my-tendermint/tendermint/libs/events"
...
// SetPrivValidator设置用于签署投票的私有验证人帐户。
...
// any event channels or this may sync
...
func (cs *ConsensusState) handleMsg(mi msgInfo) {
	...
	case *VoteMessage:
		...
		if err == ErrAddingVote {
			...
			// a typical peer.
			// https://my-tendermint/tendermint/issues/1281
		}
	...
	if err != nil {
		...
		// https://my-tendermint/tendermint/issues/3406
...
func (cs *ConsensusState) voteTime() time.Time {
	...
	// even if cs.LockedBlock != nil. See https://my-tendermint/spec.
