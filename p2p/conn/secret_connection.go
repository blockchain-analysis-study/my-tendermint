...
// See https://my-tendermint/tendermint/blob/0.1/docs/sts-final.pdf for
...
// (TODO(ismail): see also https://my-tendermint/tendermint/issues/3010)
...
func computeDHSecret(remPubKey, locPrivKey *[32]byte) (shrKey *[32]byte, err error) {
	...
	// related to: https://my-tendermint/tendermint/issues/3010
	zero := new([32]byte)
