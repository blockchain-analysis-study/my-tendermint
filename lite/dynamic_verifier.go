...
import (
	...
	log "my-tendermint/tendermint/libs/log"
	lerr "my-tendermint/tendermint/lite/errors"
...
// see https://my-tendermint/tendermint/issues/3170
...
func (dv *DynamicVerifier) Verify(shdr types.SignedHeader) error {
	...
	// See https://my-tendermint/tendermint/issues/3174.
