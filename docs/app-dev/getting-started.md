...
[here](https://my-tendermint/tendermint/wiki/Setting-GOPATH) for
more info.

Then run

```
go get my-tendermint/tendermint
...
human-readable](https://my-tendermint/tendermint/issues/1794).
...
[here](https://my-tendermint/js-abci), then install it:

```
git clone https://my-tendermint/js-abci.git
cd js-abci
npm install abci
```
