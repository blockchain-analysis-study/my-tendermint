...
application](https://my-tendermint/tendermint/blob/develop/abci/example/kvstore/kvstore.go),
which is a part of the abci repo. [persistent_kvstore
application](https://my-tendermint/tendermint/blob/develop/abci/example/kvstore/persistent_kvstore.go)
...
Commit, or there will be sync. Note also that all remaining
...
docs](https://godoc.org/my-tendermint/tendermint/lite#hdr-How_We_Track_Validators)
