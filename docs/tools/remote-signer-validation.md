...
[Tendermint](https://my-tendermint/tendermint).
...
you how to execute its tests against [KMS](https://my-tendermint/kms).
...
See the [KMS repo](https://my-tendermint/kms) for details on how to set
