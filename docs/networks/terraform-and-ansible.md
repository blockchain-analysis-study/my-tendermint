...
script](https://my-tendermint/tendermint/blob/develop/networks/remote/integration.sh)
...
```
cd $GOPATH/src/my-tendermint/tendermint/networks/remote/terraform
```
...
directory](https://my-tendermint/tendermint/tree/master/networks/remote/ansible)
run ansible roles to configure the sentry node architecture. You must
switch to this directory to run ansible
(`cd $GOPATH/src/my-tendermint/tendermint/networks/remote/ansible`).
...
from [this
directory](https://my-tendermint/tendermint/tree/master/docs/examples).
...
```
ansible-playbook -i inventory/digital_ocean.py -l sentrynet config.yml -e BINARY=$GOPATH/src/my-tendermint/tendermint/build/tendermint -e CONFIGDIR=$GOPATH/src/my-tendermint/tendermint/docs/examples
```
