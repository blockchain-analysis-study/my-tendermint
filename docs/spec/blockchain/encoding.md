...
Tendermint uses the proto3 derivative [Amino](https://my-tendermint/go-amino) for all data structures.
...
specification](https://my-tendermint/go-amino#amino-encoding-for-go) for
more details.
...
spec](https://my-tendermint/go-amino#computing-the-prefix-and-disambiguation-bytes).
...
[#1622](https://my-tendermint/tendermint/issues/1622).
