...
tries to send a `/broadcast_tx` to Tendermint during Commit, it will sync.
...
proposal. See [#1861](https://my-tendermint/tendermint/issues/1861).
...
See issue [#1007](https://my-tendermint/tendermint/issues/1007) for how
