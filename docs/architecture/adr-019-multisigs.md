...
This ADR assumes that [replacing crypto.Signature with []bytes](https://my-tendermint/tendermint/issues/1957) has been accepted.
...
Evidence for this is outlined in [this issue](https://my-tendermint/tendermint/issues/2077).
...
- Larger codebase, however this should reside in a subfolder of tendermint/crypto, as it provides no new interfaces. (Ref #https://my-tendermint/go-crypto/issues/136)
