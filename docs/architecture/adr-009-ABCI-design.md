...
- [ABCI v0.10.3 Specification (before this
  proposal)](https://my-tendermint/abci/blob/v0.10.3/specification.rst)
- [ABCI v0.11.0 Specification (implementing first draft of this
  proposal)](https://my-tendermint/abci/blob/v0.11.0/specification.md)
- [Ed25519 addresses](https://my-tendermint/go-crypto/issues/103)
- [InitChain contains the
  Genesis](https://my-tendermint/abci/issues/216)
- [PubKeys](https://my-tendermint/tendermint/issues/1524)
- [Notes on
  Header](https://my-tendermint/tendermint/issues/1605)
- [Gogoproto issues](https://my-tendermint/abci/issues/256)
- [Absent Validators](https://my-tendermint/abci/issues/231)
