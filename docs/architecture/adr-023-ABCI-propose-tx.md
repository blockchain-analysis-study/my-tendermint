...
25-06-2018: Initial draft based on [#1776](https://my-tendermint/tendermint/issues/1776)

## Context

[#1776](https://my-tendermint/tendermint/issues/1776) was
...
[line](https://my-tendermint/tendermint/blob/master/consensus/state.go#L906).
...
- [#1776 Plasma and "Internal" Transactions in ABCI Apps](https://my-tendermint/tendermint/issues/1776)
