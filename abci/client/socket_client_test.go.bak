...
func TestSocketClientStopForErrorsync(t *testing.T) {
	...
	case <-time.After(time.Second * 4):
		t.Fatalf("Test took too long, potential sync still exists")
	}
}
