...
import (
	...
	"my-tendermint/tendermint/libs/db"
	protodb "my-tendermint/tendermint/libs/db/remotedb/proto"
)
...
//  * memdB
//  * leveldb
// See https://godoc.org/my-tendermint/tendermint/libs/db#DBBackendType
