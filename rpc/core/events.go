...
import (
	...
	tmquery "my-tendermint/tendermint/libs/pubsub/query"
	ctypes "my-tendermint/tendermint/rpc/core/types"
	rpctypes "my-tendermint/tendermint/rpc/lib/types"
)
...
// https://godoc.org/my-tendermint/tendermint/types#pkg-constants
//
// For complete query syntax, check out
// https://godoc.org/my-tendermint/tendermint/libs/pubsub/query.
//
// ```go
// import "my-tendermint/tendermint/libs/pubsub/query"
// import "my-tendermint/tendermint/types"
//
