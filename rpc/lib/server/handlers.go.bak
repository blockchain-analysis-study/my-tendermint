...
import (
	...
	types "my-tendermint/tendermint/rpc/lib/types"
)
...
// If some writes don't set it while others do, they may timeout incorrectly (https://my-tendermint/tendermint/issues/553)
