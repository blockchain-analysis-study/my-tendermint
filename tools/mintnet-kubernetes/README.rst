...
::
    ...
    git clone https://my-tendermint/tools.git && cd tools/mintnet-kubernetes/examples/basecoin && make create
...
::
    ...
    curl -Lo app.yaml https://my-tendermint/tools/raw/master/mintnet-kubernetes/app.template.yaml
